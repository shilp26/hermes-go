...
const LUCIDE = {
  ...
  messageSquare: `<path d="M21 15a2 2 0 0 1-2 2H/7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>`.replace('/','2'),
  brain: `<path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.979A4 4 0 0 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.979A4 4 0 0 1 12 18Z"/><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.979A4 4 0 0 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.979A4 4 0 0 1 12 18Z"/><path d="M9 13a4.5 4.5 0 0 0 3-4"/><path d="M6.003 12.125a3 3 0 0 0 .997 4.5"/><path d="M11.003 5.125a3 3 0 0 1 .997-2.5"/><path d="M15 13a4.5 4.5 0 0 1-3-4"/><path d="M17.997 12.125a3 3 0 0 1-.997 4.5"/><path d="M12.997 5.125a3 3 0 0 0-.997-2.5"/>`,
  workflow: `<rect x="3" y="3" width="6" height="6" rx="1"/><rect x="9" y="15" width="6" height="6" rx="1"/><path d="M6 9v3a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V9"/><path d="M9 6h4a2 2 0 0 1 2 2v4"/>`,
  radio: `<path d="M4 16v-2.5C4 12.166 5.166 11 6.5 11H8"/><path d="M4 8v-.5C4 6.167 5.167 5 6.5 5H8"/><path d="M16 8c1.5 0 2.5.667 2.5 2v4c0 1.5-1 2.5-2.5 2.5"/><path d="M20 14c0 3-2 4-2 4"/><path d="M20 8c0 3 2 4 2 4"/><circle cx="12" cy="12" r="2"/>`,
  ...
  messageSquareText: `<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 9h8"/><path d="M8 13h6"/>`,
    ...
    segments: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: 'Status badges', desc: 'Success and failure state per run', where: 'Work · Cron · row' },
        ],
      },
      {
    ...
    segments: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: 'Profiles', desc: 'Create, switch, and manage profiles', where: 'System · Setup · Profiles' },
